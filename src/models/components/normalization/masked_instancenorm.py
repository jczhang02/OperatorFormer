# Copy from https://gist.github.com/ilya16/c622461000480e66ae906dd9dbe8ea26
...
__all__ = ["MaskedInstanceNorm1d", "MaskedInstanceNorm2d", "MaskedInstanceNorm3d"]
...
def masked_instance_norm(
    ...
    running_var_ = running_var[None, :].repeat(b, 1) if running_var is not None else None
    ...
    if use_input_stats:
        ...
        if running_mean is not None:
            assert running_mean_ is not None
...
class _MaskedInstanceNorm(_InstanceNorm):
    def __init__(self, num_features, eps=1e-5, momentum=0.1, affine=True, track_running_stats=True):
        super(_MaskedInstanceNorm, self).__init__(num_features, eps, momentum, affine, track_running_stats)
